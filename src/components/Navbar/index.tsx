...
export default function Navbar() {
    return <>
        <nav className="w-screen min-h-[8vh] h-fit bg-blue-600 p-3 px-3 flex gap-2 flex-col md:flex-row md:gap-6">
            ...
            <div className="flex justify-start align-center w-full h-max gap-2 my-auto">
